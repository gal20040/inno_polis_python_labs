...
#
#         self.array_of_alphabet = self.parse_initial_description_to_array(description_list[1])
#
#         self.initial_state = description_list[2]
#
...
#                 return i
#
#     def compute_test(self, test_cases_list):
#         result_string = ""
#         arrow = "->"
