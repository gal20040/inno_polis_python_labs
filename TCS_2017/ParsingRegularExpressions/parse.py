...
#         # if self.need:
#         #     self.result = self.result + " " + state.name
...
#                     self.result = self.result + " " + transition_state.name
...
#         ndfsa1 = ndfsa_stack.pop()
#         state0 = self.create_state()
#         state0.epsilon.append(ndfsa1.start)  # = [ndfsa1.start, ndfsa2.start]
#         state0.epsilon.append(ndfsa2.start)  # = [ndfsa1.start, ndfsa2.start]
...
#         state0 = self.create_state()
#         state1 = self.create_state()
#         state0.epsilon.append(ndfsa1.start)  # state0.epsilon = [ndfsa1.start]
